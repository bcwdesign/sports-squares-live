...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Clutch Squares — Real-time NBA & NFL Squares" },
      { name: "description", content: "Create private NBA and NFL Squares games for live watch parties. Real-time scoring, neon UI, second-screen ready." },
      { name: "theme-color", content: "#0a0a0f" },
      { property: "og:title", content: "Clutch Squares — Real-time NBA & NFL Squares" },
      { property: "og:description", content: "Create private NBA and NFL Squares games for live watch parties. Real-time scoring, neon UI, second-screen ready." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Clutch Squares — Real-time NBA & NFL Squares" },
      { name: "twitter:description", content: "Create private NBA and NFL Squares games for live watch parties. Real-time scoring, neon UI, second-screen ready." },
