...
export const Route = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sign in to Clutch Squares to host or join real-time NBA and NFL Squares games with friends. Email, Google, or guest access." },
      { property: "og:title", content: "Sign In — Clutch Squares" },
      { property: "og:description", content: "Sign in to Clutch Squares to host or join real-time NBA and NFL Squares games with friends." },
